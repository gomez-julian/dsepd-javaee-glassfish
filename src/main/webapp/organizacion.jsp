...
<style type="text/css">
    ...
    <form class="log-in" action="ServletOrganizacion" autocomplete="off" method="post">
        <h4>Crear <span>EMPRESA</span></h4>
        <p>Registre los siguientes datos:</p>
        <div class="floating-label">
            <input placeholder="Nombre" type="text" name="nombre" id="nombre" autocomplete="off">
