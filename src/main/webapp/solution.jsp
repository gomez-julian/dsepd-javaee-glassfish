...
<%
    ...
    String picture = (error == null)? "poly-success" : "poly-error";
%>
<div class="session">
    <div class="<%=picture%>">
...
<style type="text/css">
    ...
    <form action="polynomial" class="log-in" autocomplete="off" method="get">
        <h4>Solución de la <span>ECUACIÓN</span></h4>
        <p>Resolución mediante la fórmula general</p>
        <p><%=message%></p>
        <%
            if (error == null) {
        %>
        <div class="floating-label">
            <input type="text" name="original" id="original"
                   ...
                   value="<%=original%>"
            >
            <label for="original">Ecuación original:</label>
        </div>
        <div class="floating-label">
